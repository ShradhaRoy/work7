...
public interface BankingServices {
	...
	List<Transaction>getAccountAllTransaction(long accountNo)throws BankingServicesDownException,
	AccountNotFoundException;
	String getAccountStatus(long accountNo)throws AccountBlockedException;		
